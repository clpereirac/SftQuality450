...
test('Cuando se tienen 4 diplomados (4, 0, 0, 0), debería devolver 4', () => {
    expect(CalcularDiplomado(4, 0, 0, 0)).toBe(4); 
});

test('Cuando se tienen más de 4 diplomados (5, 0, 0, 0), debería devolver 4', () => {
    expect(CalcularDiplomado(5, 0, 0, 0)).toBe(4); 
});
